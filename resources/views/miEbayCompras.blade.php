    ...
    <div class="container my-3">
        ...
        <div class="row">
            ...
            <div class="row my-4 mx-1">
                <div class="col-2 border border-black rounded-pill">Todas las compras</div>
            </div>

            <div class="row">
                <div class="col-6 fw-bold fs-4">Pedidos</div>
                <div class="col text-end align-self-end">Ver pedidos: Todos</div>
            </div>
